...
class TestE2EFullFlow:
    ...
    def test_full_day_flow(self, tmp_db_path):
        eid1 = add_expense("2025-06-18", 85, "餐飲", "Brian", "50/50", "早餐", base_dir=tmp_db_path)
        eid2 = add_expense("2025-06-18", 120, "餐飲", "Partner", "50/50", "午餐", base_dir=tmp_db_path)
        eid3 = add_expense("2025-06-18", 800, "餐飲", "Brian", "60/40", "火鍋", base_dir=tmp_db_path)
        ...
        deleted = delete_expense(eid1, base_dir=tmp_db_path)
...
class TestE2ESoftDeleteConsistency:
    ...
    def test_soft_delete_excluded_everywhere(self, tmp_db_path):
        eid_keep = add_expense("2025-06-01", 100, "餐飲", "Brian", "50/50", "keep this", base_dir=tmp_db_path)
